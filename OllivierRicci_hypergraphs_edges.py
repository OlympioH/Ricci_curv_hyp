...
def _compute_ricci_curvature(H: hnx.Hypergraph, H_star:hnx.Hypergraph, G: nx.Graph, LG:nk.Graph, nx2nk, weight="weight", **kwargs):
    ...
    **kwargs
    ...
    edge_ricci = _compute_ricci_curvature_edges(H, H_star, G, LG, nx2nk, weight=weight, **kwargs)
...
def _compute_ricci_flow(H: hnx.Hypergraph, H_star:hnx.Hypergraph, G: nx.Graph, LG: nk.Graph, nx2nk, weight="weight",
    ...
    **kwargs
    ...
    if nx.get_edge_attributes(G, "original_RC"):
        ...
        _compute_ricci_curvature(H, H_star, G, LG, nx2nk, weight=weight, **kwargs)
