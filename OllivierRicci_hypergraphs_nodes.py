...
class OllivierRicciHypergraphNodes:
    ...
    def __init__(self, H: hnx.classes.hypergraph.Hypergraph, transport_weight='none', weight="weight", alpha=0.5, method="OTDSinkhornMix",
        ...
        transport_type :
            -'nodes' are transported, hypergraph transformed into clique graph
            -'edges' are transported, hypergraph transformed into line graph
            -'co': both nodes and edges are (co-optimally) transported. To develop...
