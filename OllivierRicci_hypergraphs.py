...
class OllivierRicciHypergraph:
    ...
    def __init__(self, H: hnx.classes.hypergraph.Hypergraph, transport_type='nodes', transport_weight='none', weight="weight", alpha=0.5, method="OTDSinkhornMix",
